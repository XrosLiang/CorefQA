...
tf.flags.DEFINE_string("output_dir", "data", "The output directory of the model training.")
...
def main(_):
    ...
    config.num_train_steps = config.num_docs * config.num_epochs
    ...
    if FLAGS.do_train:
        train_input_fn = file_based_input_fn_builder(
            ...
            is_training=True,
            drop_remainder=True)
        estimator.train(input_fn=train_input_fn, max_steps=config.num_train_steps)
